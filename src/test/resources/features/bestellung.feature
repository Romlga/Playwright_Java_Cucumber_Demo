Feature: Bestellprozess im Demo-Online-Shop
  ...
  Scenario: Bestellprozess - Teil 1 aus 3
    ...
    When ich den Test pausieren möchte bis "2025-09-03T15:46:00"

  @Teil1 @Ablauf_1
  Scenario: Ablauf - Teil 1 aus 2
    Given ich öffne den Demo-Shop
    When ich den Test pausieren möchte bis "2025-09-03T15:48:00"
  ...
  Scenario: Bestellprozess - Teil 2 aus 3
    Given ich öffne den Demo-Shop
    When ich den Test pausieren möchte bis "2025-09-02T15:55:00"
